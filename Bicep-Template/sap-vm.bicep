...
param Script_URL string = 'https://raw.githubusercontent.com/baky2014/btm-sap-on-az/main/Scripts/diskConfig.sh'

@description('URL of the disk configuration script')
param Script_URL_PWS string = 'https://raw.githubusercontent.com/baky2014/btm-sap-on-az/main/Scripts/diskConfig.ps1'
...
resource vmName_csExtension_internalOSType_Name 'Microsoft.Compute/virtualMachines/extensions@2018-10-01' = {
  ...
  properties: {
    ...
    settings: {
      ...
      commandToExecute: '${csExtensionscriptCall} ${sizes[sapSystemSize].scriptArguments[internalOSType]}'
    }
  }
}
